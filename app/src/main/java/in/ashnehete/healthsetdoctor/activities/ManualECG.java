...
public class ManualECG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manual_ecg);
    ...
    public void submitSMS(View view){
        EditText temp = (EditText) findViewById(R.id.sms_ecg);
        sms = temp.getText().toString();
        ArrayList<String> myList = new ArrayList<String>(Arrays.asList(sms.split(",")));
        Log.i("ECG Values", String.valueOf(myList));
        for (String one_point : myList) {
            series.update(Integer.parseInt(one_point));
        }
    }
